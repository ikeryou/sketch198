    ...
    this._mesh = new Points(
      ...
      new RawShaderMaterial({
        ...
        uniforms:{
          ...
          trail:{value:1},
          useMouse:{value:Conf.instance.IS_SP ? 0 : 1},
  ...
  public getGeo():BufferGeometry {
    ...
    while(itemKey < pNum) {
      ...
      while(outlineKey < outlineNum) {
        ...
        for(let i = 0; i < 360; i++) {
          const radian = Util.instance.radian((outlineKey * 30) + (360 / bunkatu) * i)
